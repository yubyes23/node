...
// const i = await globalThis.getEngine('聚合短剧[短]', {do: 'cat', ac: 'list', t: '七猫', ext: ''})
// console.log(i)

// const j = await globalThis.getEngine('剧圈圈', {do: 'ds', ac: 'list', t: 'dianying', ext: ''})
// console.log(j)

// const k = await globalThis.getEngine('夜猫影视', {do: 'ds', ac: 'list', t: '2', ext: ''})
// console.log(k)

const l = await globalThis.getEngine('剧圈圈', {do: 'ds', play: 'https://www.jqqzx.cc/play/62202-3-1.html',ext: ''})
console.log(l)